...
WASD 移動|空白鍵 跳(風語石:二段/三段跳、按住滑翔)|Shift 閃避|左鍵短按普攻/按住集氣迴旋斬(滿氣加衝擊波)|Q 舉盾|E 火焰斬|C 地震波|V 冰箭|X 瞬移|G 熔岩噴發(溶岩石,命中灼燒)|Z 連鎖閃電(雷光果,麻痺)|T 引力漩渦(引力果,聚怪)|R 藥水|F 對話/上下船/潛入/設置重生點|Tab 背包|M 地圖(當前海域島嶼相對位置)|ESC 設定
